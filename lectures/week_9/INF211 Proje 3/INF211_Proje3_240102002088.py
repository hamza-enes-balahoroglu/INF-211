...
# -------------------------------------------------------------------------
# Adı Soyadı    : Hamza Enes Balahoroğlu
# Öğrenci No    : 240102002088
# -------------------------------------------------------------------------
...
def PalaceGossip(monarchs, gossip_rate, year, verbose):
    ...
    if random.random() < gossip_rate:
        ...
        for m in monarchs:
            ...
            # Eğer hafızada kurbanla ilgili veri varsa:
...
def Diplomat(monarchs, theta_trust, wt, wr, p_gate, verbose):
    ...
    """
    #_________ADIM 1: Aday Çiftleri Belirle _______________
    ...
    # ________________ADIM 2: Tercih Sıralaması Oluştur ___________
    ...
    for k in range(max_rank):
        ...
        for i in range(len(monarchs)):
            ...
            # Zaten eşleştiyse veya listesi kısaysa geç
